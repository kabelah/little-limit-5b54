...
```
npm create cloudflare@latest -- --template=cloudflare/templates/little-limit-5b54
```

A live public deployment of this template is available at [https://little-limit-5b54.templates.workers.dev](https://little-limit-5b54.templates.workers.dev)
